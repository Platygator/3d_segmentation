...
data_set = "simulation_8"             # Which data set generate labels from
setting = "simulation"        # Which settings file to use (expected to be save in /settings/
...
TRUST = crf_settings["ground_trust"]
